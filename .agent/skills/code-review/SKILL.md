---
name: code-review
description: Reviews code changes for bugs, style issues, and best practices. Provides comprehensive code review guidance for React 19, Vue 3, Rust, TypeScript, Java, Python, and C/C++. Use when reviewing pull requests, conducting PR reviews, or checking code quality.
allowed-tools:
  - Read
  - Grep
  - Glob
